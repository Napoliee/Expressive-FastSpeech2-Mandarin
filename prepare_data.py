...
from preparation import aihub_mmv, iemocap, esd
...
def main(args, preprocess_config):
    ...
    elif "ESD-Chinese" in preprocess_config["dataset"]:
        if args.extract_lexicon:
            esd.extract_lexicon(preprocess_config)
        else:
            esd.create_dataset(preprocess_config)
