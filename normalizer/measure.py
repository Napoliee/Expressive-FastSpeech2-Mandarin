...
Version:
Author: Xie Chang
Date: 2021-08-12 14:43:03
LastEditors: Xie Chang
LastEditTime: 2021-08-12 14:54:54
'''
# -*- coding: utf-8 -*-
...
measure_suffix_single_pattern = \
    r"(匹|张|座|回|场|尾|条|个|首|阙|阵|网|炮|顶|丘|棵|只|支|袭|辆|挑|担|颗|壳|窠|曲|墙|群|腔|\
       ...
       纪|岁|世|更|夜|春|夏|秋|冬|代|伏|辈|丸|泡|粒|颗|幢|堆|条|根|支|道|面|片|张|颗|块|克|米|点)"
...
MEASURE_PATTERN = r"({0}{1})".format(MEASURE_NUMBER_PATTERN,
                                     measure_suffix_pattern)


class Measure(Normalizer):
    def __init__(self):
